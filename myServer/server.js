...
function serverFunction(){
    ...
    //create server pass the serverOptions
        const server = https.createServer(serverOptions, (request, response) =>{
            ...
            //folder path of the filenames, where the server gets the files
            let folderPath = path.join(__dirname, "../myWebsite", filename)

            //readfile, pass folderpath, return content when succeeded
